...
|---|---|---|
| **Conversa** | Sí | Sí |
| **Consulta datos reales** | No (o muy limitado) | Sí |
| **Ejecuta acciones** | No | Sí (reservas, emails, tickets...) |
| **Coordina varios pasos** | No | Sí (orquestador) |
| **Se adapta a lo que pasa** | No (flujo fijo) | Sí (decide según contexto) |
| **Necesita supervisión humana** | Sí | Sí, igual o más |
